...
with open(output_file, "w") as outfile, open("system_properties.str", "w") as strout:
    ...
    ndnaa = nheta = nsolv = nacey = nbenx = ndmee = nform = nimid = nmamy = nmeoh = nprpx = 0
    ...
    for i, line in enumerate(lines):
        ...
        if line.startswith("ATOM"):
            ...
            if resn in ['ADE', 'CYT', 'GUA', 'THY', 'DA', 'DC', 'DG', 'DT']:
                segid = "DNAA"
            ...
            if atoms > 1:
                ...
                if prevline.startswith("ATOM"):
                    ...
                    if prevresn in ['ADE', 'CYT', 'GUA', 'THY', 'DA', 'DC', 'DG', 'DT']:
                        prevsegid = "DNAA"
                    elif prevresn == 'POT':
                        prevsegid = "HETA"
    ...
    strout.write("set ndnaa " + str(ndnaa) + "\n")
